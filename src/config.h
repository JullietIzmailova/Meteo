...
#define MAIN_LOOP_DELAY 2 //задержка процедуры Loop() после очередной итерации (чем значение больше, тем контроллер менее нагружен, но "хуже" реагирует на события)
...
#define MAIN_LOOP_COUNT_LIMIT 60 
